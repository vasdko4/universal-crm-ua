#!/usr/bin/env bash
# ─────────────────────────────────────────────────────────────────────
# Universal Magazine — daily production database backup.
#
...
#      under BACKUP_DIR (default /var/backups/magazine).
#   2. Deletes local backups older than RETENTION_DAYS (default 14).
#   3. If RCLONE_REMOTE is set (e.g. "b2:my-bucket/magazine-backups"),

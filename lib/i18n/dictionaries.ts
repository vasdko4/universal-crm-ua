...
const uk: Dictionary = {
  ...
  product: {
    ...
    chooseOption: 'Оберіть: {{name}}',
    outOfStockOption: '{{name}} — немає в наявності',
  ...
  footer: {
    ...
    about: 'Інтернет-магазин. Доставка по всій Україні, гарантія на всі товари.',
  ...
  serverErrors: {
    ...
    promoMinOrder: 'Мінімальна сума замовлення для промокоду — {{amount}} ₴',
...
const ru: Dictionary = {
  ...
  product: {
    ...
    chooseOption: 'Выберите: {{name}}',
    outOfStockOption: '{{name}} — нет в наличии',
  ...
  footer: {
    ...
    delivery: 'О доставке',
    about: 'Интернет-магазин. Доставка по всей Украине, гарантия на все товары.',
  ...
  serverErrors: {
    ...
    promoMinOrder: 'Минимальная сумма заказа для промокода — {{amount}} ₴',

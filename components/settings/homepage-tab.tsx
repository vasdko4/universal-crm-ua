...
export function HomepageSection({ data, setData, t }: SectionProps) {
  ...
  const ph =
    heroLocale === 'uk'
      ? {
          badge: 'Каталог',
          title: 'Усе для дому, саду та щодня',
          text: 'Одяг, сад, авто, електрообладнання та аксесуари…',
          buttonText: 'Усі категорії',
        }
      : {
          badge: 'Каталог',
          title: 'Всё для дома, сада и на каждый день',
          text: 'Одежда, сад, авто, электрооборудование и аксессуары…',
